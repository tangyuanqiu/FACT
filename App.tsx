...
const getCategoryColor = (category: Category) => {
  switch (category) {
    case Category.MATHEMATICS: return 'bg-blue-100 text-blue-700 border-blue-200'; // Keep Math blue
...
const getCategoryDotColor = (category: Category) => {
  switch (category) {
    case Category.MATHEMATICS: return 'bg-blue-500'; // Keep Math blue
             ...
             {requests.slice(0, 3).map(req => {
               ...
               return (
                 <div 
                    ...
                    className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:shadow-md hover:border-[#002D62]/30 transition-all cursor-pointer group flex flex-col h-full"
                 >
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex justify-end">
          <button 
            ...
            className="flex items-center gap-2 text-sm font-medium text-[#002D62] hover:text-[#002D62] bg-blue-50 hover:bg-blue-100 px-4 py-2 rounded-lg transition-colors border border-blue-100"
          >
            ...
            <tbody className="divide-y divide-slate-100">
              {requests.map(req => {
                ...
                return (
                  ...
                  >
                    <td className="p-4">
                      <div className="font-bold text-[#002D62] group-hover:text-[#002D62]">{comp?.shortName || comp?.name || 'Unknown'}</div>
                    ...
                    <td className="p-4">
                      <button className="text-[#002D62] hover:text-[#002D62]/80 font-medium text-xs sm:text-sm bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 h-screen sticky top-0 z-20">
        <div className="p-6 border-b border-slate-100">
          <Link to="/" className="flex items-start gap-3">
             <div className="w-10 h-10 bg-[#002D62] rounded-xl flex items-center justify-center text-white shadow-md shadow-[#002D62]/20 flex-shrink-0 mt-1">
...
const App: React.FC = () => {
  ...
  // State for the new "Large Interface" modal
