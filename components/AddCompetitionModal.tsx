        ...
        {step === 'form' ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className="p-6 space-y-4">
               <div className="bg-blue-50 text-[#002D62] text-sm p-3 rounded-lg border border-blue-100">
            ...
            <div className="p-6 border-t border-slate-100 flex justify-end gap-3">
              ...
              <button type="submit" className="px-6 py-2 bg-[#002D62] hover:bg-[#002D62]/90 text-white rounded-lg text-sm font-medium shadow-sm">Submit Request</button>
            </div>
          </form>
        ) : (
