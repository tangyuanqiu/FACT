    ...
    <div className="animate-fade-in max-w-4xl mx-auto pb-12">
             ...
             <div className="pt-6 border-t border-slate-300">
               {competition.website ? (
                  <a 
                    ...
                    className="inline-flex items-center justify-center gap-2 bg-[#002D62] hover:bg-[#002D62]/90 text-white px-6 py-2.5 rounded-xl font-bold transition-all shadow-sm hover:shadow-md w-full sm:w-auto text-sm"
                  >
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm mb-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative px-4">
           ...
           <div className="flex md:flex-col items-start md:items-center gap-4 text-left md:text-center relative">
             <div className="md:hidden absolute left-[9px] top-6 bottom-[-2.5rem] border-l-2 border-dashed border-slate-300"></div>
             <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-white border-2 border-[#002D62] shadow-sm shadow-[#002D62]/20 flex-shrink-0 mt-1 md:mt-0 z-10 relative"></div>
             <div>
           ...
           <div className="flex md:flex-col items-start md:items-center gap-4 text-left md:text-center relative">
             <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#002D62] flex-shrink-0 mt-1 md:mt-0 z-10 shadow-md shadow-[#002D62]/20 relative"></div>
             <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {relatedRequests.map(req => (
                    ...
                    >
                        ...
                        <button className="w-full py-1.5 text-xs font-medium text-[#002D62] bg-[#002D62]/10 hover:bg-[#002D62]/20 rounded-lg transition-colors flex items-center justify-center gap-1">
