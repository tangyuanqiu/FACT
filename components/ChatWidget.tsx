  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end">
          ...
          <div className="p-4 bg-white border-t border-slate-100">
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="bg-[#002D62] hover:bg-[#001b3d] disabled:bg-slate-300 text-white p-2 rounded-full transition-colors"
              >
      ...
      <button 
        ...
        className={`${isOpen ? 'bg-slate-800 opacity-100' : 'bg-[#002D62] hover:bg-[#001b3d] opacity-90 hover:opacity-100'} text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2`}
      >
